...
router.get("/getParticipants", (req, res) => {
    const dbQuery = 'SELECT *, Users.first_name, Users.last_name, Users.email, Users.phone_number ' +
        'FROM Participants LEFT JOIN Users ON Participants.user_id = Users.user_id ' +
        'Join Training_Sessions ON Participants.training_session_id = Training_Sessions.training_session_id ' +
        'WHERE Participants.status_id = 1 AND Users.user_id Is Not Null';
